...
//
//	endPointAddress := Address{IP: address.Ip}
//	grpc_conn, err := NewClientConn(endPointAddress, false, nil)
//
//	streamWrapper, err := Connect(grpc_conn)
//
//	if err != nil {
//		return nil, err
//	}
...
//			}
//
//			conn, err := NewConnection(*connectedConnInfo, streamWrapper, bih.mux)
//
//			go func() {
